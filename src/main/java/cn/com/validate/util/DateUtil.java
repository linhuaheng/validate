package cn.com.validate.util;

import cn.com.iscs.common.util.StringUtils;
...
public class DateUtil {
    ...
    public static String format(Date date, String format, String timezone) {
        ...
        if (cn.com.iscs.common.util.StringUtils.isNotEmpty(timezone)) {
    ...
    public static Date parse(String dateString, String format, String timezone) {
        if (cn.com.iscs.common.util.StringUtils.isEmpty(dateString)) return null;
    ...
    private static boolean isDateTime(String str, String format) {
        if (cn.com.iscs.common.util.StringUtils.isEmpty(str) || StringUtils.isEmpty(format)) {
            return false;
        }
